<cfset film=createObject("component", "#application.componentPrefix#GetFilms")/>
	...
	<table class="myborder" style="font-family:Arial, Helvetica, sans-serif;" cellspacing="0px;" width="100%">
		...
		<cfloop index="film" array="#films#">
			<tr <cfif count % 2>class="background"</cfif>>
				...
				<td>
					<a href="javascript:if(confirm('Are you sure you want to delete #film.Title#?')){window.location='#application.ComponentRoot#DeleteFilm.cfc?method=deleteFilm&film_id=#film.id#';}"><img src="#application.imagePrefix#delete.gif" style="border:none;"/></a>
				</td>
			</tr>
			<cfset count += 1/>
		</cfloop>
