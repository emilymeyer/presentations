<cfcomponent hint="automatic test suite runner">
	...
	<cffunction name="run" access="public" hint="runs a directory of tests" returntype="any" output="false">
		...
		<cfargument name="excludes" required="false" default="" hint="list of Tests, in cfc notation, to exclude. uses ListFind so it's as greedy as possible. Currently does not support ant-style syntax or whole-directory filtering">
